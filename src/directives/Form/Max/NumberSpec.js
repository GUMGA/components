describe('Gumga.core:directives:MaxNumber', () => {
  ...
  describe('max', () => {
    it('should valid input value',() => {
      ...
      expect(controller.changeStateOfInput).toHaveBeenCalledWith('idade', 'maxnumber', true, 10);
    ...
    it('should invalid input value',() => {
      ...
      expect(controller.changeStateOfInput).toHaveBeenCalledWith('idade', 'maxnumber', false, 10);
