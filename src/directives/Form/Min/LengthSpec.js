describe('Gumga.core:directives:MaxLength', () => {
  ...
  describe('max', () => {
    it('should valid input value',() => {
      ...
      expect(controller.changeStateOfInput).toHaveBeenCalledWith('nome', 'minlength', false, 10);
    ...
    it('should invalid input value', () => {
      ...
      expect(controller.changeStateOfInput).toHaveBeenCalledWith('nome', 'minlength', true, 10);
